...
/**
 * Get LO API's Providers for the local_inokufu plugin.
 *
...
class get_provider extends common_request
{
    /**
    ...
    {
        return self::get_and_cache_data('provider', short_cache: false);
    }
    ...
    public static function execute_returns()
    {
        return new external_multiple_structure(
            new external_single_structure(
                [
                    'id_provider' => new external_value(PARAM_TEXT, 'Provider ID'),
                    'name' => new external_value(PARAM_TEXT, 'Provider name'),
                    'url' => new external_value(PARAM_TEXT, 'Provider URL'),
                ]
            )
        );
    }
