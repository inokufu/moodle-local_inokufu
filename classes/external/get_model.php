...
/**
 * Get LO API's Models for the local_inokufu plugin.
 *
...
class get_model extends common_request
{
    ...
    {
        return self::get_and_cache_data('model', short_cache: false);
    }
    ...
    public static function execute_returns()
    {
        return new external_multiple_structure(
            new external_single_structure(
                [
                    'id_model' => new external_value(PARAM_TEXT, 'Model ID'),
