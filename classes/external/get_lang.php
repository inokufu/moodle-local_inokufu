...
/**
 * Get LO API's Langs for the local_inokufu plugin.
 *
...
class get_lang extends common_request
{
    /**
    ...
    {
        return self::get_and_cache_data('lang', short_cache: false);
    }
    ...
    public static function execute_returns()
    {
        return new external_multiple_structure(
            new external_single_structure(
                [
                    'id_lang' => new external_value(PARAM_TEXT, 'Language ID'),
