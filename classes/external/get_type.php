...
/**
 * Get LO API's Types for the local_inokufu plugin.
 *
...
class get_type extends common_request
{
    /**
    ...
    {
        return self::get_and_cache_data('type', short_cache: false);
    }
    ...
    public static function execute_returns()
    {
        return new external_multiple_structure(
            new external_single_structure(
                [
                    'id_type' => new external_value(PARAM_TEXT, 'Type ID'),
